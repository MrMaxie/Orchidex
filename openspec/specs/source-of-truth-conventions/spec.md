# source-of-truth-conventions Specification

## Purpose
Describe current repository conventions for source-of-truth alignment, language, dependencies, and local-only files.
## Requirements

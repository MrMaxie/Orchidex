...
- [x] 1.2 Add local file-backed storage for graphs, active sparks, run history, queues, diagnostics, and replay metadata.
...
- [x] 2.3 Reconcile live graph edits against active sparks and blocked routes.
